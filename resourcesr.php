                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox" style="min-width: 0px;">
                     <li>.</li><li></li>
                      <li><a class=""><i class="fa fa-info" data-toggle="tooltip" data-placement="top" title="" data-original-title="Video Resources."></i></a>
                      </li>                      
                    </ul>  
                    <div class="clearfix"></div>
                  </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox" style="min-width: 0px;">
                     <li>.</li><li></li>
                      <li><a class=""><i class="fa fa-info" data-toggle="tooltip" data-placement="top" title="" data-original-title="Important Documents."></i></a>
                      </li>                      
                    </ul>  
                    <div class="clearfix"></div>
                  </div>
